...
public static class DbExtensionMethodGenerator
{
    ...
    public static void Register(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(compilationAndClasses, BuildSource);
    ...
    private static void BuildSource(SourceProductionContext sps, (Compilation Compilation, ImmutableArray<MethodDeclarationSyntax> Methods) source)
    {
        try
        {
            foreach (var method in source.Methods)
            {
                ...
                try
                {
                    sps.AddSource(method.Identifier.Text + ".DbExtensionMethods.g.cs", SourceText.From(sp.ToString(), Encoding.UTF8));
                }
                catch (Exception)
                {

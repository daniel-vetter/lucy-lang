...
namespace Lucy.Assembler.Infrastructure
{
    public class MachineCodeWriter
    {
        ...
        public void ValidateOperand(IOperand operand, out bool isValid) => isValid = ValidateOperand(operand);
        public bool ValidateOperand(IOperand operand)
        {
        ...
        public void WriteAddressSizePrefixIfRequired(IOperand rm1, IOperand? rm2 = null)
        {
            Memory? m = null;
        ...
        public bool Encode(IRegisterOrMemory rm, byte registerOrOpcodeExtension)
        {

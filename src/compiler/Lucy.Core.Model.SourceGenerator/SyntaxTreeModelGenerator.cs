    ...
    internal static class SyntaxTreeModelGenerator
    {
        internal static void Generate(SourceProductionContext productionContext, Config config)
        {
            ...
            foreach (var node in config.Nodes)
            {
                ...
                sb.WriteGetChildNodesMethod(config, node);
        ...
        private static void WriteConstructor(this StringBuilder sb, Config config, Node node)
        {
        ...
        private static void WriteProperties(this StringBuilder sb, Config config, Node node)
        {
        ...
        private static void WriteGetChildNodesMethod(this StringBuilder sb, Config config, Node node)
        {
            if (node.BasedOn == null)
            {
